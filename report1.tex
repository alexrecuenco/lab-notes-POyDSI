...
\subsection{Aplicar usando los image J, dos metodos de deconvolucion 
dos metodos de deconvolución: Regularized Inverse Filter y Richardson-Lucy a una imagen test obtenida por un sistema con una PSF conocida y diferentes tipos de ruido: Gauss y Poisson.}

Imagen test original’ref’ e imagen del PSF ’psf’.

    \begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{Simulation deconvolution/psf.jpg}
    \caption{Imagen PSF }
    \label{f:psf}
    \end{figure}
