...
\begin{figure}[hbp]
	...
	\begin{tabular}{ l | c c c }
		Luz coherente                                                                               &
		\centerbox{parte5-luz-coherente/imagen-letras.png}                                          &
		\centerbox{parte5-luz-coherente/imagen-letras-no-difusor-y-grating-enfocado-en-grating.png} &
		\centerbox{parte5-luz-coherente/imagen-letras-no-difusor-y-grating.png}                       \\
		\hline
		Luz incoherente                                                                             &
		\centerbox{parte5-luz-coherente/imagen-letras-con-difusor-mas-lejos.png}                    &
		\centerbox{parte5-luz-coherente/imagen-letras-con-difusor-moviendose.png}                   &
		\centerbox{parte5-luz-coherente/imagen-letras-con-difusor-y-grating-enfocado-en-grating.png}  \\
		                                                                                            &
		\centerbox{parte5-luz-coherente/imagen-letras-con-difusor-y-grating.png}                    &
		\centerbox{parte5-luz-coherente/imagen-letras-con-difusor.png}                              &
	\end{tabular}
	\caption{Letras a través de un difusor moviendose para generar luz coherente o incoherente. Notese que }
