...
Se toma los espectros de Fourier de las imágenes en cuestión presentadas a continuación en la figura ~\ref{fig:fourier:all}.
...
\subsubsection{Cuestión 1 }
    \begin{enumerate}
        \item ¿Qué valores $d_1$ y $d_2$ son adecuados para la observación del espectro de Fourier?
    \end{enumerate}
